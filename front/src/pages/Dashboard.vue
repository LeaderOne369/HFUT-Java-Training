      ...
      <el-card class="box-card">
        <template #header>
          <div class="card-header">
            <el-avatar class="avatar-box" :src="admin.avatar" shape="square" :size="40"> </el-avatar>
...
const loadAdmin = async () => {
  ...
  const data = { username:  'admin', avatar: 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png' }
  updateAdmin({
